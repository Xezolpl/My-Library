...
public class BookNotesTabFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter.addFragment(chaptersTabFragment, getString(R.string.chapters_notes));
        adapter.addFragment(quotesTabFragment, getString(R.string.quotes));
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_book_notes, container, false);
        initWidgets(view);
